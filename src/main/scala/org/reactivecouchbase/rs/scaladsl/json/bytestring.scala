...
package object bytestring {
  ...
  implicit val defaultByteStringFormat: JsonFormat[ByteString] =
    JsonFormat(defaultByteStringReads, defaultByteStringWrites)

  implicit val defaultByteStringConverter: CouchbaseJsonDocConverter[ByteString] =
    new CouchbaseJsonDocConverter[ByteString] {
